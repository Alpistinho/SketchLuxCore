module SketchLux
	...
	class Camera
		...
		@@typeParameters["perspective"] = ['oculusrift.barrelpostpro.enable', 'fieldofview']
		@@typeParameters["stereo"] = ['oculusrift.barrelpostpro.enable', 'fieldofview', 'eyesdistance', 'lensdistance']
		@@typeParameters["orthographic"] = []
		...
		def definition()
			...
			definitionLines ||= []
			definitionLines << 'scene.camera.type = ' + @type
