module SketchLux
	...
	class Volume
		...
		@@commonParameters = ["priority", "ior", "absorption", "emission", "emission.id"]
		...
		@@typeParameters["homogeneous"] = ['scattering', 'asymmetry', 'multiscattering', 'steps.size', 'steps.maxcount']
		@@typeParameters["heterogeneous"] = ['scattering', 'asymmetry', 'multiscattering', 'steps.size', 'steps.maxcount']
